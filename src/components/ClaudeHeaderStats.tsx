...
function Stat({ label, value, accent }: { label: string; value: string; accent?: boolean }) {
  return (
    <div className="flex flex-col items-end">
      <span className="text-[9px] text-cyan-400/50 uppercase tracking-[0.2em] font-mono">
        {label}
      </span>
      <span
...
export function ClaudeHeaderStats() {
  ...
  return (
    <div className="flex items-center gap-4 px-4 py-2 rounded-lg border border-cyan-400/20 bg-cyan-500/5 backdrop-blur-sm shrink-0">
      <div className="flex flex-col">
        <span className="text-[9px] text-cyan-400/60 uppercase tracking-[0.25em] font-mono">
          Claude Code
        </span>
      ...
      <div className="flex items-center gap-1.5">
        ...
        />
        <span className="text-[9px] text-cyan-300/80 uppercase tracking-[0.2em] font-mono">
          Operational
        </span>
      </div>
    </div>
